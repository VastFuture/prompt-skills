...
### AI 思考与推理框架（[skills/ai-thinking-reasoning-frameworks/](./skills/ai-thinking-reasoning-frameworks/)）

| 技能 | 说明 |
|------|------|
| [claude-enhanced-logic-thinking](./skills/ai-thinking-reasoning-frameworks/claude-enhanced-logic-thinking/) | Claude 深度思考协议，激活全面推理流程 |
| [enhance-llm-logic-analysis](./skills/ai-thinking-reasoning-frameworks/enhance-llm-logic-analysis/) | 逐步推理链与多方法验证，JSON 格式输出 |
| [four-deep-thinking-methods](./skills/ai-thinking-reasoning-frameworks/four-deep-thinking-methods/) | 四种追问模式：目标拆解、苏格拉底式、第一性原理、复盘前置 |
| [internal-thinking-ai-framework](./skills/ai-thinking-reasoning-frameworks/internal-thinking-ai-framework/) | 内部思考组织与 AI 结构化思维框架 |
| [key-ai-communication-methods](./skills/ai-thinking-reasoning-frameworks/key-ai-communication-methods/) | 基于知识重叠的四种 AI 交流策略 |
| [thinking-navigation-assistant](./skills/ai-thinking-reasoning-frameworks/thinking-navigation-assistant/) | 复杂信息可视化思维模型，逻辑结构化呈现 |
| [universal-system-prompt](./skills/ai-thinking-reasoning-frameworks/universal-system-prompt/) | 量子织锦认知引擎框架，多维深度思考 |
